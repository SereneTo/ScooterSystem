...
public class UserGUI_SelectScooter {
	...
	protected ImageIcon light = new ImageIcon("src/images/light.gif");
	protected ImageIcon light_off = new ImageIcon("src/images/light_off.png");
	...
	protected ImageIcon icon1 = new ImageIcon("src/images/timg2.jpg");
	protected ImageIcon icon2 = new ImageIcon("src/images/timg.jpg");
	protected ImageIcon icon3 = new ImageIcon("src/images/timg3.jpg");
	protected ImageIcon icon4 = new ImageIcon("src/images/timg4.jpg");
