 ...
 * @param parkingNumInA the scooters available in station A.
 * @param parkingNumInB the scooters available in station B.
 * @param parkingNumInC the scooters available in station C.
 * @param bikeOnTheWay the scooters are currently used.
 *
 * @author Group 44
 * @version 1.0
 */
